...
- 荷物預かり
    - チェックアウト後も荷物はコンシェルジュデスクやフロントデスク、ホテルの入り口横で預かってくれるので預けるのもあり
        - そうするとレゴランドで遊んだ後とりに寄る必要があるがパーク目の前だから問題なし？
    - 「キャリーケースを含む大きなお手荷物」はパーク持ち込み禁止とあるので、ボストンバッグだとしてもホテルに預けるしかないかも
